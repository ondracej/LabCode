clear, clc
metadata=load('Z:\zoologie\HamedData\P1\w0009 juv\w0009');
data_info=metadata.w0009;
for k= 1:1
...
[EEG, time, r_dif_med_removed, t_frame] = load_for_connectivity(chnl_order,dir_add,vid_fname, roi);
